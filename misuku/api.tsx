...
/** Asset system model */
export type AssetImageFeatureArgs = {
...
export type AssetCreateInput = {
  ...
  imageFeature?: InputMaybe<FeatureCreateManyInlineInput>;
...
export type AssetManyWhereInput = {
  ...
  imageFeature_every?: InputMaybe<FeatureWhereInput>;
  imageFeature_none?: InputMaybe<FeatureWhereInput>;
  imageFeature_some?: InputMaybe<FeatureWhereInput>;
...
export type AssetUpdateInput = {
  ...
  height?: InputMaybe<Scalars['Float']>;
  imageFeature?: InputMaybe<FeatureUpdateManyInlineInput>;
...
/** Collection of products, e.g. Juices. */
...
export enum NumberOfDays {
  Apice = 'APICE',
  BoxOf_24Bottles = 'BOX_OF_24_BOTTLES',
}
...
/** Number of days for the order duration */
...
export type ProductColorVariantManyWhereInput = {
  ...
  /** All values starting with the given string. */
  id_starts_with?: InputMaybe<Scalars['ID']>;
  numberOfDays?: InputMaybe<NumberOfDays>;
  /** All values that are contained in given list. */
  numberOfDays_in?: InputMaybe<Array<InputMaybe<NumberOfDays>>>;
  /** All values that are not equal to given value. */
  numberOfDays_not?: InputMaybe<NumberOfDays>;
  /** All values that are not contained in given list. */
  numberOfDays_not_in?: InputMaybe<Array<InputMaybe<NumberOfDays>>>;
...
export enum ProductColorVariantOrderByInput {
  ...
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
  NumberOfDaysAsc = 'numberOfDays_ASC',
  NumberOfDaysDesc = 'numberOfDays_DESC',
  PriceAsc = 'price_ASC',
...
export type ProductCreateInput = {
  categories?: InputMaybe<CollectionCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** description input for default locale (en) */
  description: Scalars['String'];
...
export type ProductManyWhereInput = {
  ...
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars['String']>;
  categories_every?: InputMaybe<CollectionWhereInput>;
  categories_none?: InputMaybe<CollectionWhereInput>;
  categories_some?: InputMaybe<CollectionWhereInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type ProductUpdateInput = {
  categories?: InputMaybe<CollectionUpdateManyInlineInput>;
  /** description input for default locale (en) */
  description?: InputMaybe<Scalars['String']>;
...
export type PageHeroDetailsFragment = {
  __typename?: 'Hero';
  title?: string | null;
  slug?: string | null;
...
export type GetPageHeroQueryVariables = Exact<{ [key: string]: never }>;

export type GetPageHeroQuery = {
  __typename?: 'Query';
  hero?: {
    __typename?: 'Hero';
    title?: string | null;
...
export const PageHeroDetailsFragmentDoc = gql`
  fragment PageHeroDetails on Hero {
    title
    image {
      url
    }
...
`;
export const GetPageHeroDocument = gql`
  query GetPageHero {
    hero(where: { id: "cl876jiv172i30bun0qj9av1h" }) {
      ...PageHeroDetails
    }
  }
  ${PageHeroDetailsFragmentDoc}
`;

/**
 * __useGetPageHeroQuery__
 *
 * To run a query within a React component, call `useGetPageHeroQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPageHeroQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPageHeroQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetPageHeroQuery(
  baseOptions?: Apollo.QueryHookOptions<GetPageHeroQuery, GetPageHeroQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetPageHeroQuery, GetPageHeroQueryVariables>(GetPageHeroDocument, options);
}
export function useGetPageHeroLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetPageHeroQuery, GetPageHeroQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetPageHeroQuery, GetPageHeroQueryVariables>(
    GetPageHeroDocument,
    options,
  );
}
export type GetPageHeroQueryHookResult = ReturnType<typeof useGetPageHeroQuery>;
export type GetPageHeroLazyQueryHookResult = ReturnType<typeof useGetPageHeroLazyQuery>;
export type GetPageHeroQueryResult = Apollo.QueryResult<
  GetPageHeroQuery,
  GetPageHeroQueryVariables
>;
